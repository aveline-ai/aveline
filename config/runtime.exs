...
#
#     PHX_SERVER=true bin/aveline start
#
...
use_logflare_in_dev = config_env() == :dev && System.get_env("DEV_LOG_TO_LOGFLARE") == "yes"
# Logging in prod and optionally in dev to testing logging works as expected.
if config_env() == :prod || use_logflare_in_dev do
  if(config_env() == :prod) do
    IO.puts("[logging] output to prod logflare")
  else
    IO.puts("[logging] output to dev logflare")
  end
  ...
  IO.puts("[logging] output to terminal")
end
