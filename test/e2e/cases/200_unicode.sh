...
test_unicode_title_round_trips() {
  ...
  run_cli -w "$ws" create-doc --visibility workspace --title "$title" --blocks "$blocks"
...
test_emoji_in_paragraph_round_trips() {
  ...
  run_cli -w "$ws" create-doc --visibility workspace --title "Emoji" --blocks "$blocks"
...
test_long_summary_accepted() {
  ...
  local blocks; blocks="[$(block_paragraph 'b')]"
  run_cli -w "$ws" create-doc --visibility workspace --title "Long" --summary "$summary" --blocks "$blocks"
...
test_too_long_summary_rejected() {
  ...
  local blocks; blocks="[$(block_paragraph 'b')]"
  run_cli -w "$ws" create-doc --visibility workspace --title "TooLong" --summary "$summary" --blocks "$blocks"
...
test_multibyte_in_code_block() {
  ...
  run_cli -w "$ws" create-doc --visibility workspace --title "World" --blocks "$blocks"
