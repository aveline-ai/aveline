defmodule AvelineWeb.Ui.Button do
  ...
  defp get_button_classes(size, hierarchy) do
    ...
    "#{padding_classes} #{border_radius_classes} #{border_color_classes} #{gap_classes} #{text_size_classes} #{text_color_classes} #{text_weight_classes}"
  end
  ...
  defp get_button_border_color_classes("secondary_gray"), do: "border border-border-secondary"

  defp get_button_gap_classes("sm"), do: "gap-1"

  defp get_button_text_size_classes("sm"), do: "text-sm"

  defp get_button_text_color_classes("secondary_gray"), do: "text-button-secondary-fg"
  ...
  defp get_button_icon_classes(size, hierarchy) do
    ...
    "#{button_icon_size_classes} #{button_icon_color_classes}"
  end
